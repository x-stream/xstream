...
public class ToAttributedValueConverter implements Converter {
    ...
    public void marshal(final Object source, final HierarchicalStreamWriter writer, final MarshallingContext context) {
        ...
        reflectionProvider.visitSerializableFields(source, (final String fieldName, final Class<?> type1, final Class<?> definedIn, final Object value) -> {
			...
			ConverterMatcher converter = Enum.class.isAssignableFrom(type1) ? (ConverterMatcher) enumMapper.getConverterFromItemType(null, type1, null) : (ConverterMatcher)mapper.getLocalConverter(definedIn,
				fieldName);
			if (converter == null) {
