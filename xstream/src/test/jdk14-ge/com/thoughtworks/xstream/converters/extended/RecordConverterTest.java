...
public class RecordConverterTest extends AbstractAcceptanceTest {
    ...
    /** Test where non-primitive record component is omitted during serialisation.
     * The components' default value null is inserted during deserialisation.*/
    public record RecordOmittedNonPrimitive
            (byte b, short s, int i, long l, float f, double d, char c, boolean bool, String str) { }

    static final RecordOmittedNonPrimitive RONP =
            new RecordOmittedNonPrimitive((byte)0, (short)0, 0, 0l, 0.0f, 0.0d, '\u0000', false, null);
    ...
    /** Test where primitive record component values are missing in the xml.
     * In this case the default values of the respective types are inserted
     * during deserialisation.*/
    public record RecordOmittedPrimitive (byte b, short s, int i, long l, float f, double d, char c, boolean bool, String str) { }

    static final RecordOmittedPrimitive ROP = new RecordOmittedPrimitive((byte)0, (short)0, 0, 0l, 0.0f, 0.0d, '\u0000', false, null);
